...
return new class extends Migration
{
    public function up()
    {
        Schema::create('ligne_commande_vente', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('commande_vente_id');
            $table->unsignedBigInteger('produit_id');
            $table->string('code_produit', 255)->nullable();
            $table->string('nom_produit', 255);
            $table->string('description', 255)->nullable();
            $table->decimal('quantite', 16, 2);
            $table->decimal('quantite_livree', 16, 2)->default(0);
            ...
            // Index
            $table->index(['commande_vente_id', 'produit_id']);
    ...
    {
        Schema::dropIfExists('ligne_commande_vente');
    }
};