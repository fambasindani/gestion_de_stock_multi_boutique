...
return new class extends Migration
{
    public function up()
    {
        Schema::create('commande_vente', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('etat', ['brouillon', 'confirme', 'en_cours', 'termine', 'annule'])->default('brouillon');
            ...
            $table->string('reference_commande_client', 100)->nullable();
    ...
    {
        Schema::dropIfExists('commande_vente');
    }
};